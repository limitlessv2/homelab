...
EOF'
  ...
  lxc-attach -n "$CTID" -- bash -c "$(wget -qLO - https://raw.githubusercontent.com/limitlessv2/homelab-scripts/refs/heads/main/proxmox/artifactory/artifactory-install.sh)" || exit
